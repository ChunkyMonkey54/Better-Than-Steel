...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, EMERALD_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.EMERALD_ORE_KEY),
                ModOrePlacement.modifiersWithCount(33,
                        HeightRangePlacementModifier.uniform(YOffset.fixed(-63), YOffset.fixed(64))));
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(BetterThanSteel.MOD_ID, name));
    }
